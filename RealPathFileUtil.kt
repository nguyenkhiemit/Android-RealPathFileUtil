 ...
 */
class RealPathFileUtil {

    companion object {
        var realFileInstall: RealPathFileUtil? = null
        fun getInstance(): RealPathFileUtil {
            if (realFileInstall == null) {
                realFileInstall = RealPathFileUtil()
            }
            return realFileInstall!!
        }
    }
